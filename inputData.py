...
for class_name in class_names:
    ...
    while True:
        ...
        cv2.rectangle(frame, (bottomLeftCornerOfText[0] - 5, bottomLeftCornerOfText[1] - text_height - 5),
                      (bottomLeftCornerOfText[0] + text_width + 5, bottomLeftCornerOfText[1] + 5), text_background_color, -1)
    ...
    for i in range(num_samples_per_class):
        ret, frame = camera.read()
        # Construct the image path and name (e.g. "A_0.jpg", "A_1.jpg", etc.)
